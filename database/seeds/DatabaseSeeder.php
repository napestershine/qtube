...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $numberOfUser = $this->command->ask('How many users do you need ?', 50);
        ...
        $videoRange = $this->command->ask('How many videos per channel should have, give a range ?', '10-50');
        ...
        $commentRange = $this->command->ask('Give a range for comments per video ?', '10-15');
